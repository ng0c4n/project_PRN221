...
public class DashboardsController : Controller
{
    ...
    public IActionResult DashboardData()
    {
        ...
        var result = new
        {
            ...
            IncreasePercentProfit = profitYesterday != 0 ? Math.Round(profitToday / profitYesterday * 100, 2) : 100,
            IncreasePercentProduct = productBeforeToday != 0 ? Math.Round((decimal)productToday / productBeforeToday * 100, 2) : 100,
